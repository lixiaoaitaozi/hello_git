...
/**
 * @className :EditTextClearView
 * @purpose: 自定义搜索框
 * @author:
 * @data:2017/11/10 20:48
 */

public class EditTextClearView extends android.support.v7.widget.AppCompatEditText {
...
// 初始化该组件时，对EditText_Clear进行初始化 ->>步骤2
    ...
    public EditTextClearView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    private void init() {
        clearDrawable = getResources().getDrawable(R.mipmap.ic_launcher);
